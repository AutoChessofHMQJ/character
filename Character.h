...
#define HERO_Ruizi                     8040      //瑞兹
#define HERO_Jax                       8041      //贾克斯
#define HERO_Kaerma                    8042      //卡尔玛
#define HERO_Talike                    8043      //塔里克
#define HERO_Modekaisa                 8044      //莫德凯撒
#define HERO_Delaiwen                  8045      //德莱文
#define HERO_Daianna                   8046      //戴安娜
#define HERO_Weikezi                   8047      //维克兹
#define HERO_Aiwen                     8048      //艾翁
#define HERO_Efeiliusi                 8049      //厄斐流斯
#define HERO_Ruier                     8050      //芮尔
#define HERO_Kaier                     8051      //凯尔
#define HERO_Inventor                  8052      //发明家
#define HERO_Gailun                    8053      //盖伦
#define HERO_Wolibeier                 8054      //沃利贝尔
#define HERO_Delaiesi                  8055      //德莱厄斯
#define HERO_Qianjue                   8056      //千珏
#define HERO_Foyege                    8057     //佛耶戈
#define HERO_Timo                      8058      //提莫
...
struct skill
{
	void setSkill(int ad,int ap,int real,int regrn,int dbf,int dbfe, int bf,int bfe);
	int damageAD;
	int damageAP;
	int damageREAL;
	int Regen;
...
protected:
	...
	skill h_Skill;                                  //英雄技能
	int h_ATKMANA = 10;                               //普攻回蓝
	bool h_isDead;                                  //标记是否死亡
	bool h_isDebuff;                                //能否被添加debuff
	int h_Debuff;                                   //负面状态种类(不同数字代表不同状态)
	double h_DebuffEffect;                          //负面效果数值
	bool h_onStage;                                 //是否登场
	bool h_isSold;                                  //是否出售
	int h_Shield;                                   //护盾（没有为0，有则表示护盾值）
	bool h_isTargeted;                              //能否被选中为目标，如果死亡则不能
	bool h_isMove;                                  //能否移动
	//int h_Armed[3];                                 //英雄装备
